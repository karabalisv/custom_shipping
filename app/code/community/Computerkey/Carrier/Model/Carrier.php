...
/**
* @karabalisv
* @Model Extends Shipping Carrier
**/
class Computerkey_Carrier_Model_Carrier extends Mage_Shipping_Model_Carrier_Abstract implements Mage_Shipping_Model_Carrier_Interface {

    protected $_code = 'computerkey_carrier';
    ...
    protected function _getStandardShippingRate() {
        ...
        $rate->setMethod($this->getConfigData('title'));
        $rate->setMethodTitle($this->getConfigData('infotext'));
